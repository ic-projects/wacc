...
// CodeGenerator v. It adds any required dependencies and will only add the function
...
// CodeGenerator v. If called twice or more there will still be only one data in
